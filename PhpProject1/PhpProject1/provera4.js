function provera_login(){
    ...
    if (!kor_reg.test(korisnicko_ime) || !loz_reg.test(lozinka) ){
        alert('Lose uneta sifra ili korisnicko ime');
        return false;
    }
}
...
function provera_registracije(){
    ...
    var broj_licence=document.forma_registracija.agencija.value;
    if(agencija=='nije_selktovano' && broj_licence==''){
