...
<table>
            ...
            <select name='grad' id="grad">
                ...
                <?php
                    foreach($gradovi as $grad){
                        if(isset($_GET['grad']) && $_GET['grad']==$grad)
    ...
    <tr>
        ...
        <td>
            <select name='stanje' id="tip">
                <?php
                $tipovi=array('izvorno','renovirano','LUX');
                foreach ($tipovi as $tip) {
                    //mozda treba []
                ?>
            
                <option  name="stanje" value="<?php echo $tip;?>"><?php echo $tip;?></option>   
                    <?php
    ...
    <tr>
        ...
        <td>
            <textarea name="opis" cols="21" rows="20">
